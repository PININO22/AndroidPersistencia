...
public class ProyectoAdapter {
    ...
    private class Columns implements BaseColumns {
        ...
        public final static String ID = "proyacto_id";
    ...
    public  final  static  String CR_TABLE= "create table ifnosexists" +NAME+"("+Columns.ID
            +"integerprimarykeyautoincrement,"
            +Columns.DESCRIPCION+ "textonull,"
            +Columns.COSTO+"real,"
            +Columns.CLIENTE_ID+"integer, FOREGIN KEY (cliente_id)REFERENCES cliente(cliente_id)";
